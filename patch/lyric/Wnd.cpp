...
BOOL Wnd::Init(HWND parent) {
    if (this->hWnd == NULL) {
        ...
        auto hwnd=CreateWindow(szWindowClass, L"Overlay Lyric View.", WS_POPUP | WS_CLIPCHILDREN | WS_CLIPSIBLINGS, 0, 0, 800, 150, parent, nullptr, this->hInstance, (LPVOID)this);
